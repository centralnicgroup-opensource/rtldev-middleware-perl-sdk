...
DISTVNAME = WebService-Hexonet-Connector-1.10
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '   "version" : "1.10",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="WebService-Hexonet-Connector" VERSION="1.10">' > WebService-Hexonet-Connector.ppd
