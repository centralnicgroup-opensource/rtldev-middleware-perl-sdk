...
DISTVNAME = WebService-Hexonet-Connector-1.07
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: '\''1.07'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "1.07",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="WebService-Hexonet-Connector" VERSION="1.07">' > WebService-Hexonet-Connector.ppd
