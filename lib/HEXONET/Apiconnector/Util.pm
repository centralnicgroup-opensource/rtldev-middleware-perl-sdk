package Hexonet::Connector::Util;
...
Hexonet::Connector::Util - utility package providing useful helper methods.

=head1 DESCRIPTION

This package represents a bundle of helper methods to are used by the Hexonet::Connector
...
=head1 METHODS Hexonet::Connector::Util
